    ...
    <div className="about">
      ...
      <div className="about-section">
        <div className="about-right">
          <div data-aos="fade-right" className=" bg-light border rounded p-4 shadow-sm text-dark about-para">
            <small>
          ...
          <div className="about-skills mb-5">
            <h2 className='tools'>Expertise in Development And Design Tools</h2>
